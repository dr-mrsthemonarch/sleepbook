...
QStringList WordCloudWidget::getStopWords() {
    ...
    "began", "begin", "beginning", "begins", "behind", "believe", "best",
    "better", "beyond", "bottom", "broad", "built", "call", "called", "cannot",
    ...
    "wonder", "word", "work", "world", "worse", "worst", "worth", "wouldn’t",
    "yeah", "year", "yes", "yet", "zero"
};
};
